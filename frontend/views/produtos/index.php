                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        ...
                                        if (!empty($model->favoritos) && isset($model->favoritos[0])) {
                                            echo Html::a('Remover Favorito', ['/produtos/removerfavoritos', 'id' => $model->id], ['name' => 'remove-favorites-button', 'class' => 'btn btn-sm btn-outline-secondary']);
                                        } else {
                                            echo Html::a('Adicionar Favorito', ['/produtos/addfavoritos', 'id' => $model->id], ['name' => 'add-favorites-button', 'class' => 'btn btn-sm btn-outline-secondary']);
                                        }
                                        ?>
                                    </div>
