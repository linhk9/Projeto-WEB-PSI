...
<div class="site-perfil">
    <div class="row">
        <div class="col-lg-5">
            ...
            <?= $form->field($model, 'primeiroNome')->textInput(['value' => $userData->primeiroNome ]) ?>
            <?= $form->field($model, 'ultimoNome')->textInput(['value' => $userData->ultimoNome ]) ?>
            <?= $form->field($model, 'telemovel')->textInput(['value' => $userData->telemovel ]) ?>
            <?= $form->field($model, 'morada')->textInput(['value' => $userData->morada ]) ?>
